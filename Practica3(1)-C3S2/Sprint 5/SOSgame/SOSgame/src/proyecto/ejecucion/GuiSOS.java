...
/////////////////////////////////////////////////////
    ...
    public void turnOFF_playerBR(){//Cuando alguien gana o hay empate o eligio dimension fuera del rango
    ...
    public void bluePlayer(){//desabilita a redPlayer
        ...
        if(SizeN(n)==n){
            ...
            for (int i = 0; i < n; i++) {
                for (int j = 0; j < n; j++) {
                    ...
                    Slots[i][j] = slot;
                    ClassScore.setInfo(i,j,-1);//espacios tablero vacios
